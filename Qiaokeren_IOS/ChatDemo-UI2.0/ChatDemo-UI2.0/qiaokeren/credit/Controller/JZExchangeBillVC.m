...
@interface JZExchangeBillVC ()<JZExchangeBillDelegate,JZDataHandleDelegate>
...
@implementation JZExchangeBillVC
...
-(void)sendQstAccpet:(NSString*)_billid billstatus:(NSString*)_billstatus{
    ...
    [changebill initWithInfo:@"接受积分账单请求，修改订单状态"
                      UserID:[QiaokerenApplication getAccountNumber]//此处测试完后 改为[QiaokerenApplication getAccountNumber]
                      billid:_billid
