...
@interface CreditBillData : JZGetValueInDictionary
{
@private
    NSString * p ;
    NSString * billid ;
...
@property(nonatomic, copy) NSString * hhtimestamp;
...
@property(nonatomic, copy) NSString * hhlocation;
