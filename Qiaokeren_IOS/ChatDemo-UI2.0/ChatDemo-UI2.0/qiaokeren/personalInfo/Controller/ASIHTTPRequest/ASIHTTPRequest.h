...
@property (retain,setter=setURL:, atomic) NSURL *url;
@property (retain) NSURL *originalURL;
@property (assign, atomic) id delegate;
@property (retain, atomic) id queue;
@property (assign, atomic) id uploadProgressDelegate;
@property (assign, atomic) id downloadProgressDelegate;
