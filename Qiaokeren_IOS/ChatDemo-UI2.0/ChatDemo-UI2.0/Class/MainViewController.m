...
@interface MainViewController () <UIAlertViewDelegate, IChatManagerDelegate, EMCallManagerDelegate, JZDataHandleDelegate>
{
    ChatListViewController *_chatListVC;
    ContactsViewController *_contactsVC;
    NewsViewController *_newsVC;
    GoodsViewController *_productVC;
...
- (void)viewDidLoad
{
    ...
    [QiaokerenApplication setAccountNumber:username];
...
#warning 把self注册为SDK的delegate
    ...
    [addButton setImage:[UIImage imageNamed:@"z_addfriends.png"] forState:UIControlStateNormal];
...
{
    //背景色
    self.tabBar.backgroundColor = [[UIColor alloc] initWithRed:242.0f/255.0f green:242.0f/255.0f blue:241.0f/255.0f alpha:1.0];
    ...
    _chatListVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"消息"
                                                           image:nil
                                                             tag:0];
    NSString *msg_selected_filePath = [[NSBundle mainBundle] pathForResource:@"msg_selected" ofType:@"png"];
    NSData *msg_selected_image = [NSData dataWithContentsOfFile:msg_selected_filePath];
    UIImage *msg_selected_img = [UIImage imageWithData:msg_selected_image];
    NSString *msg_normal_filePath = [[NSBundle mainBundle] pathForResource:@"msg_normal" ofType:@"png"];
    NSData *msg_normal_image = [NSData dataWithContentsOfFile:msg_normal_filePath];
    UIImage *msg_normal_img = [UIImage imageWithData:msg_normal_image];
    _chatListVC.tabBarItem.selectedImage = msg_selected_img;
    _chatListVC.tabBarItem.image = msg_normal_img;
    ...
    _contactsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"好友"
                                                           image:nil
                                                             tag:1];
    NSString *friends_selected_filePath = [[NSBundle mainBundle] pathForResource:@"friends_selected" ofType:@"png"];
    NSData *friends_selected_image = [NSData dataWithContentsOfFile:friends_selected_filePath];
    UIImage *friends_selected_img = [UIImage imageWithData:friends_selected_image];
    NSString *friends_normal_filePath = [[NSBundle mainBundle] pathForResource:@"friends_normal" ofType:@"png"];
    NSData *friends_normal_image = [NSData dataWithContentsOfFile:friends_normal_filePath];
    UIImage *friends_normal_img = [UIImage imageWithData:friends_normal_image];
    _contactsVC.tabBarItem.selectedImage = friends_selected_img;
    _contactsVC.tabBarItem.image = friends_normal_img;
    [self unSelectedTapTabBarItems:_contactsVC.tabBarItem];
    [self selectedTapTabBarItems:_contactsVC.tabBarItem];
    
    
    _newsVC = [[NewsViewController alloc] init];
    _newsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"资讯"
                                                       image:nil
                                                         tag:2];
    NSString *news_selected_filePath = [[NSBundle mainBundle] pathForResource:@"news_selected" ofType:@"png"];
    NSData *news_selected_image = [NSData dataWithContentsOfFile:news_selected_filePath];
    UIImage *news_selected_img = [UIImage imageWithData:news_selected_image];
    NSString *news_normal_filePath = [[NSBundle mainBundle] pathForResource:@"news_normal" ofType:@"png"];
    NSData *news_normal_image = [NSData dataWithContentsOfFile:news_normal_filePath];
    UIImage *news_normal_img = [UIImage imageWithData:news_normal_image];
    _newsVC.tabBarItem.selectedImage = news_selected_img;
    _newsVC.tabBarItem.image = news_normal_img;
    _newsVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [self unSelectedTapTabBarItems:_newsVC.tabBarItem];
    [self selectedTapTabBarItems:_newsVC.tabBarItem];
    
    _productVC = [[GoodsViewController alloc] init];
    _productVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"产品"
                                                          image:nil
                                                            tag:3];
    NSString *goods_selected_filePath = [[NSBundle mainBundle] pathForResource:@"goods_selected" ofType:@"png"];
    NSData *goods_selected_image = [NSData dataWithContentsOfFile:goods_selected_filePath];
    UIImage *goods_selected_img = [UIImage imageWithData:goods_selected_image];
    NSString *goods_normal_filePath = [[NSBundle mainBundle] pathForResource:@"goods_normal" ofType:@"png"];
    NSData *goods_normal_image = [NSData dataWithContentsOfFile:goods_normal_filePath];
    UIImage *goods_normal_img = [UIImage imageWithData:goods_normal_image];
    _productVC.tabBarItem.selectedImage = goods_selected_img;
    _productVC.tabBarItem.image = goods_normal_img;
    _productVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [self unSelectedTapTabBarItems:_productVC.tabBarItem];
    [self selectedTapTabBarItems:_productVC.tabBarItem];
    
    _orderVC = [[OrderViewController alloc] init];
    _orderVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"订单"
                                                        image:nil
                                                          tag:4];
    NSString *order_selected_filePath = [[NSBundle mainBundle] pathForResource:@"order_selected" ofType:@"png"];
    NSData *order_selected_image = [NSData dataWithContentsOfFile:order_selected_filePath];
    UIImage *order_selected_img = [UIImage imageWithData:order_selected_image];
    NSString *order_normal_filePath = [[NSBundle mainBundle] pathForResource:@"order_normal" ofType:@"png"];
    NSData *order_normal_image = [NSData dataWithContentsOfFile:order_normal_filePath];
    UIImage *order_normal_img = [UIImage imageWithData:order_normal_image];
    _orderVC.tabBarItem.selectedImage = order_selected_img;
    _orderVC.tabBarItem.image = order_normal_img;
    _orderVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [self unSelectedTapTabBarItems:_orderVC.tabBarItem];
    [self selectedTapTabBarItems:_orderVC.tabBarItem];
    
    self.viewControllers = @[_chatListVC, _contactsVC,_newsVC,_productVC,_orderVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
...
-(void)unSelectedTapTabBarItems:(UITabBarItem *)tabBarItem
{
    [tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                        [UIFont systemFontOfSize:14], UITextAttributeFont,[UIColor blackColor],NSForegroundColorAttributeName,
...
-(void)selectedTapTabBarItems:(UITabBarItem *)tabBarItem
{
    [tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                        ...
                                        NSFontAttributeName,[UIColor colorWithRed:155.0f/255.0f green:211.0f/255.0f blue:210.0f/255.0f alpha:1.000],NSForegroundColorAttributeName,
...
- (void)sendVersionUpdateMsg{
    NSString *version = [NSString stringWithFormat:@"%@", [[NSBundle mainBundle] objectForInfoDictionaryKey:(NSString*)kCFBundleVersionKey]];
    
    JZCheckVersionAndOtherInfo_c *li = [JZCheckVersionAndOtherInfo_c Jz_initialize];
    [li initWithInfo:@"JZCheckVersionAndOtherInfo_c" UserID:[QiaokerenApplication getAccountNumber] UploadTime:[UtilsAll getFormatTime222] Version:@"0" MacAddress:version UUID:@"0"];
    NSDictionary *nsdic = [li toDictionary];
    JZDataHandle * jzDataHandle = [JZDataHandle initdatahandle];
    jzDataHandle.JZDatadelegate = self;
    [jzDataHandle sendObject:nsdic time:@"122112" protocol:12212 label:@"JZCheckVersionAndOtherInfo_c"];
    
}

BOOL isNew = false,isUser = false;
// 处理函数
- (void)dealLabel:(NetUnit*)nUnit{
    //    NSLog(@"dealLabel --- JZCheckVersionAndOtherInfo_c");
    if ([nUnit->cLabel isEqualToString:@"JZCheckVersionAndOtherInfo_c"]) {
        ...
        if ([[dictionary objectForKey:@"Mark"]isEqualToString:@"1"]) {
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"系统提示" message:@"有版本更新，请更新后进入" delegate:self cancelButtonTitle:nil otherButtonTitles:nil, nil];
            [alertView show];
        }else{
            NSLog(@"已是最新版本！");
            isNew = true;
    ...
    if ([nUnit->cLabel isEqualToString:@"JZgetQUserInfo_c"]) {
        ...
        NSString* json = nUnit->receiveString;
        //                NSLog(@"123456-------JZgetQUserInfo_c-----------%@",json);
        NSDictionary*dictionary = [[NSJSONSerialization JSONObjectWithData:[json dataUsingEncoding:  NSUTF8StringEncoding ] options:NSJSONReadingMutableContainers error:nil] objectAtIndex:0 ];
        ...
        if ([[dictionary objectForKey:@"Mark"]isEqualToString:@"1"]) {
            ...
            //            NSLog(@"setUserSelectData 123456 ！qlevel:%@",personalInfo.qlevel);
            //            [self showHudInView:self.view hint:@"正在发送申请..."];
            EMError *error;
            NSString *upUser = [[NSString alloc] initWithFormat:@"%@",[dic objectForKey:@"qhigherid"]];
            [[EaseMob sharedInstance].chatManager addBuddy:upUser message:@"我是您的下一级代理。" error:&error];
            //            [self hideHud];
            isUser = true;
