    ...
    if (_searchController == nil) {
        ...
        [_searchController setCellForRowAtIndexPathCompletion:^UITableViewCell *(UITableView *tableView, NSIndexPath *indexPath) {
            ...
            if (conversation.conversationType == eConversationTypeChat) {
                ...
                NSString *url = [QiaokerenApplication getTouXiangUrlUserID:conversation.chatter];
...
-(UITableViewCell *)tableView:(UITableView *)tableView
    ...
    NSString* nick = [ContactsViewController getNickNameByUserId:conversation.chatter];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *title = [ContactsViewController getNickNameByUserId:conversation.chatter];
    if (conversation.conversationType != eConversationTypeChat) {
